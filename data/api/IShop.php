...
interface IShop
{
     ...
     */
    function updateShopConfigByshop($shop_id, $shop_logo, $shop_banner, $shop_avatar, $shop_qrcode, $shop_qq, $shop_ww, $shop_phone, $shop_keywords, $shop_description, $shop_hint);
     ...
     */
    function updateShopConfigByPlatform($shop_id, $shop_name, $shop_group_id, $shop_platform_commission_rate,$service_charge_rate, $bond_collection_method, $bond, $shop_type,$shop_credit,$shop_desccredit, $shop_servicecredit, $shop_deliverycredit, $store_qtian, $shop_zhping, $shop_erxiaoshi, $shop_tuihuo, $shop_shiyong, $shop_shiti, $shop_xiaoxie, $shop_huodaofk, $shop_state, $shop_close_info);
