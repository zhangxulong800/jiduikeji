...
class NsMemberFavoritesModel extends BaseModel {
    ...
    public function getShopsFavouitesViewQuery($page_index, $page_size, $condition, $order)
    {
        $viewObj = $this->alias('nmf')
            ...
            ->field('ns.shop_id,ns.shop_name,ns.shop_type,ns.shop_group_id,ns.shop_company_name,ns.province_id,ns.city_id, ns.latitude_longitude,
            ns.shop_address,ns.shop_zip,ns.shop_state,ns.shop_close_info,ns.shop_sort,ns.shop_create_time,ns.shop_end_time, nsg.group_name,
