...
class NsPromotionDiscountGoodsViewModel extends BaseModel {
    ...
    public function getViewQuery($page_index, $page_size, $condition, $order)
    {
        ...
        ->field('npdg.discount_goods_id,npdg.discount_id,npdg.start_time,npdg.end_time,npdg.goods_id,npdg.status,npdg.discount,npdg.goods_name,npdg.goods_picture,ng.category_id_1,ng.price,ng.promotion_price, ng.price, ng.market_price, ng.description, ng.cost_price, ng.total_cost_price');
