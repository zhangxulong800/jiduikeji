...
class Goods extends SimpleController
{
    ...
    { 
		...
		$point_info = $cf->getInfo(['shop_id' => 0],'convert_rate');//0替换$shop_id
    ...
    public function goodsList()
    {
        ...
        $this->assign("user_location", get_city_by_ip()); // 获取用户位置信息
        $stop_sell = 1;
        $goods_list = $this->getGoodsListByConditions($category_id, $brand_id, $min_price, $max_price, $keyword, $page, $page_size, $orderby, $shipping_fee, $stock, $platform_proprietary, $province_id, $attr_array, $stop_sell);
     ...
     */
    public function getGoodsListByConditions($category_id, $brand_id, $min_price, $max_price, $keyword, $page, $page_size, $order,
                                             $shipping_fee, $stock, $platform_proprietary, $province_id, $attr_array, $stop_sell = 0)
    {
        $this->goods = new GoodsService();
        $condition = null;
        if ($category_id != "") {
