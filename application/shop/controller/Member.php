 ...
 */
class Member extends SimpleController
{
    ...
    public function testUniPoint()
    {
        ...
        if (isset($_POST["submit"])) {
            $calc_date = isset($_POST["calc_date"]) ? $_POST["calc_date"] : "";
            $C29 = isset($_POST["C29"]) ? $_POST["C29"] : "";
            $C10 = isset($_POST["C10"]) ? $_POST["C10"] : "";
            $C11 = isset($_POST["C11"]) ? $_POST["C11"] : "";
            $C18 = isset($_POST["C18"]) ? $_POST["C18"] : "";
            $D26 = isset($_POST["D26"]) ? $_POST["D26"] : "";
//            $D27 = isset($_POST["D27"]) ? $_POST["D27"] : "";
            $D28 = isset($_POST["D28"]) ? $_POST["D28"] : "";
//            $D29 = isset($_POST["D29"]) ? $_POST["D29"] : "";

            if(($calc_date != '')&&($C10 != '')&&($C11 != '')&&($D28 != '')){
                $data = UniPoint::CalculatePoint($calc_date, $C10, $C11, $D28);
                $C18 = $data[0]['r18'];
                $D27 = $data[0]['r27'];
                $D29 = $data[0]['r29'];
            }
        ...
        $this->assign('D28', $D28);
        $this->assign('D29', $D29);
        return view($this->style . 'Member/testUniPoint');
//        return view($this->style . 'Member/personInformation');
    ...
    public function orderList($page = 1, $page_size = 10)
    {
		...
		$orderService->orderFinish();//完成线下扫描支付订单
 ...
 /**
    ...
    {  //pc端不用
        ...
        ], 'max_buy,state,point_exchange_type,point_exchange,picture,goods_id,goods_name,shop_id');
        ...
        //$cart_list["price"] = $member_price < $sku_info['promote_price'] ? $member_price : $sku_info['promote_price'];暂未用
        $cart_list["price"] = $sku_info['price'];
		$cart_list["price"] = $member_price;
		$cart_list["goods_id"] = $goods_info["goods_id"];
        $cart_list["goods_name"] = $goods_info["goods_name"];
		$cart_list["shop_id"] = $goods_info["shop_id"];
...
//        include_once('/data/pc_mob/orderInfo.php');
