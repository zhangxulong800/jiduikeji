...
class BaseController extends SimpleController
{
    ...
    public function getShareContents()
    {
            ...
            switch ($flag) {
                case "shop":
                    ...
                    if (! empty($this->uid)) {
                        ...
                        $current_user = "分享人44：" . $user_info["nick_name"];
                    } else {
                        if(!empty($shop_id))
                        {
                ...
                case "qrcode_shop":
                    ...
                    $current_user = "分享人33：" . $user_info["nick_name"];
                    break;
                case "qrcode_my":
                    ...
                    $current_user = "分享人11：" . $user_info["nick_name"];
                    break;
            }
        } else {
            if (! empty($this->uid)) {
                ...
                $current_user = "分享人22：" . $user_info["nick_name"];
            } else {
        ...
        switch ($flag) {
            ...
            case "goods":
                ...
                $points = ($goods_detail["market_price"]-$goods_detail["cost_price"])*0.2;
                $pointss = $points*6;
                ...
                $share_content["share_contentss"] = 'Jplus价' . "￥" . $goods_detail["market_price"] . $config["goods_param_2"];
                $share_content["share_contentsss"] = '返' . $points . '积分'.",   " . $config["goods_param_2"];
                $share_content["share_contentssss"] = '积分收益' .'￥'. $pointss . $config["goods_param_2"];
                $share_content['share_nick_name'] = $current_user;
