...
function createTable(){
	...
	if(shopId == '0'){
		...
		th_html += '<th class="th-price">建议销售价（元）</th>';
	}
	th_html += '<th class="th-price">结算价（元）</th>';
	...
	if(shopId == '0'){
		...
		tf_html +='	<a class="js-batch-market_price" href="javascript:;">jplus价</a>&nbsp;&nbsp;';
	}else{
		tf_html +='	<a class="js-batch-price" href="javascript:;">建议销售价</a>&nbsp;&nbsp;';
	}
	tf_html +='	<a class="js-batch-cost_price" href="javascript:;">结算价</a>&nbsp;&nbsp;';
